    ...
    <div class="lg:w-full ">
      <button class="flex items-center w-full hover:bg-lightblue rounded-full p-2">
        ...
        <div class="hidden lg:block ml-4">
          <p class="text-sm font-bold leading-tight">Mukul Jangra</p>
          <p class="text-sm text-gray-500 leading-tight">@mukul_rx</p>
        </div>
...
export default {
  name: "Sidenav",
  computed: mapGetters(['allTabs', 'GetTab']),
  methods: {
    changeRoute(id) {
      this.$store.dispatch('changeRoute', id)
    }
  }
}
</script>
